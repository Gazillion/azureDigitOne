...
class getKnpPaginatorService extends App_KernelDevContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('PaginatorProxyEd11c01', fn () => \PaginatorProxyEd11c01::createLazyProxy(fn () => self::do($container, false)));
        }
