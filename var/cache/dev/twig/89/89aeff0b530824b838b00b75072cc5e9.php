...
class __TwigTemplate_6ee80201a6015667b165245ded6502f7 extends Template
{
    private $source;
    private $macros = [];
...
($context["collector"] ?? null), "enabled", [], "any", false, false, false, 172)) {
            ...
            <div class=\"tab ";
            // line 180
            echo ((( !twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "firewall", [], "any", false, false, false, 180) || twig_test_empty(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "firewall", [], "any", false, false, false, 180), "security_enabled", [], "any", false, false, false, 180)))) ? ("disabled") : (""));
            echo "\">
...
$context["voter_detail"]) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["vote"] ?? null) : null) == twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\Voter\\VoterInterface::ACCESS_DENIED"))) {
    ...
    {
        return new Source("", "@Security/Collector/security.html.twig", "/Users/jackrima/Sites/gentella/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
